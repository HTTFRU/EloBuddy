...
namespace _HTTF_Riven
{
    internal class Riven
    {
        ...
        public static Menu Menu, ComboMenu, FarmMenu;
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            Menu.AddLabel("Coming soon DMG INDICATOR, FLEE, and etc ");
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            if (ComboMenu["Combo.R"].Cast<CheckBox>().CurrentValue)
            {
                ...
                Text.Draw("Use R in combo?: " + IsRActive, Color.AliceBlue, (int)pos.X - 45,
                    (int)pos.Y + 40);
            }
        }
